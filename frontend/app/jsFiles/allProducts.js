let AllProductsCategory = [
  ...
  },
  {
    name: "Curing Bag",
    description:
      "Durable curing bags that are essential in the retreading process for even pressure distribution.",
    imageUrl:
      "https://5.imimg.com/data5/CJ/MH/MY-1718646/curing-bag-500x500.jpg",
    ...
    products: [
      {
        ...
        description:
          "Outer envelope for ensuring secure curing during the retreading process.",
      },
      {
        name: "DOUBLE ENVELOPE ( INNER )",
        imageUrl:
          "https://midas.ind.in//public/uploads/products/1588261661.jpg",
        description: "Double inner envelope for enhanced pressure sealing.",
      },
      {
        name: "DOUBLE ENVELOPE ( OUTER )",
        imageUrl:
          "https://midas.ind.in//public/uploads/products/1588261485.jpg",
        description: "Outer double envelope for maximum sealing during curing.",
      },
      {
        name: "HALF SKIRT ENVELOPES ( No Valve)",
        imageUrl:
          "https://midas.ind.in//public/uploads/products/1588259808.jpg",
        description: "Half skirt envelope designed for valve-less systems.",
      },
      {
        name: "RIM AND TUBE",
        imageUrl:
          "https://midas.ind.in//public/uploads/products/1588261150.jpg",
        description:
          "Reliable rim and tube for tire protection during retreading.",
      },
    ],
  },
  {
    name: "Tyre Flap",
    description:
      "Tyre flaps for additional protection of tube and tire during tire installation and retreading.",
  ...
  },
  {
    name: "Orbi Tread",
    description:
      "Specialized Orbi tread for enhanced traction and durability on various terrains.",
  ...
  },
  {
    ...
    description:
      "Premium black rubber compounds for high-performance tire retreading solutions.",
  ...
  //   description:
  //     "Cushion repair compound used for filling and repairing tire punctures and surface damages.",
