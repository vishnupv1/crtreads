        ...
        <figure className="h-full w-full overflow-hidden">
          ...
          <div className="h-[500px] overflow-hidden md:hidden">
            <div style={{ padding: "180.27% 0 0 0", position: "relative" }}>
              <iframe
                ref={iframeRef1}
                src="https://player.vimeo.com/video/1059820061?autoplay=1&loop=1&muted=1&controls=0"
                frameBorder="0"
          ...
          <div className="h-[600px] lg:h-[1000px] overflow-hidden hidden md:block">
            <div style={{ padding: "86.27% 0 0 0", position: "relative" }}>
              <iframe
                ref={iframeRef2}
                src="https://player.vimeo.com/video/1059820061?h=b7dea7afc6&autoplay=1&loop=1&muted=1&controls=0&portrait=0"
                frameBorder="0"
                allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media"
                style={{
                  position: "absolute",
