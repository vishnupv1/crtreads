...
function TrendingProducts() {
  return (
    <div className="p-4 mt-8 flex justify-center  items-center bg-stone-100 shadow-inner h-full lg:h-[50vh]" >
    <div className="w-11/12 lg:w-9/12">
      <p className="text-xl md:text-2xl font-semibold mb-6">Trending Products</p>
